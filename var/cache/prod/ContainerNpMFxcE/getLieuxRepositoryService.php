...
// Returns the private 'App\Repository\LieuxRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LieuxRepository.php';

return $this->privates['App\Repository\LieuxRepository'] = new \App\Repository\LieuxRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
