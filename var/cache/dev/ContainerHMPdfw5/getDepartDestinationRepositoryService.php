...
// Returns the private 'App\Repository\DepartDestinationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DepartDestinationRepository.php';

return $this->privates['App\Repository\DepartDestinationRepository'] = new \App\Repository\DepartDestinationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
