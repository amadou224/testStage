...
// Returns the private 'App\Repository\SupplementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SupplementRepository.php';

return $this->privates['App\Repository\SupplementRepository'] = new \App\Repository\SupplementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
