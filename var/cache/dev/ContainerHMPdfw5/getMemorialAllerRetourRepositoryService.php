...
// Returns the private 'App\Repository\MemorialAllerRetourRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MemorialAllerRetourRepository.php';

return $this->privates['App\Repository\MemorialAllerRetourRepository'] = new \App\Repository\MemorialAllerRetourRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
