...
// Returns the private 'App\Repository\MemorialAllerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MemorialAllerRepository.php';

return $this->privates['App\Repository\MemorialAllerRepository'] = new \App\Repository\MemorialAllerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
