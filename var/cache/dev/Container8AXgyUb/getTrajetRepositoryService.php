...
// Returns the private 'App\Repository\TrajetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrajetRepository.php';

return $this->privates['App\Repository\TrajetRepository'] = new \App\Repository\TrajetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
