...
// Returns the private 'App\Repository\ChauffeurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ChauffeurRepository.php';

return $this->privates['App\Repository\ChauffeurRepository'] = new \App\Repository\ChauffeurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
