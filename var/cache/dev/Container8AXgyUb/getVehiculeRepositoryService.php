...
// Returns the private 'App\Repository\VehiculeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\VehiculeRepository.php';

return $this->privates['App\Repository\VehiculeRepository'] = new \App\Repository\VehiculeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
